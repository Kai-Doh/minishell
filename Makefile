...
# Sources / objects
SRCS = minishell.c prompt.c exec.c heredoc.c lexer.c expand.c parser.c path.c redir_utils.c utils.c signals.c dispatcher.c echo.c pwd.c cd.c exit.c env_utils.c export.c unset.c
OBJS = $(SRCS:.c=.o)
